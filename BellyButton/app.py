...
def homepage():
    ...
    paragraph2 ="The mission of this project was to investigate the microbes inhabiting in our navels."
    paragraph3 = "Below is an interactive dashboard displaying some the results."
